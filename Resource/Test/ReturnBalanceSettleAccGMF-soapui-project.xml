...
<con:soapui-project id="e0c2dda7-e8b2-443b-abdd-0aa781d4c326" activeEnvironment="Default" name="ReturnBalanceSettleAccGMF" resourceRoot="" soapui-version="5.6.1" abortOnError="false" runType="SEQUENTIAL" xmlns:con="http://eviware.com/soapui/config"><con:settings/><con:interface xsi:type="con:WsdlInterface" id="bf4bd08f-5571-4c9b-b4e6-ee7eabe534a4" wsaVersion="NONE" name="ReturnBalanceSettleAccGMF" type="wsdl" bindingName="{urn://grupoaval.com/accounts/v1/}ReturnBalanceSettleAccGMF" soapVersion="1_1" anonymous="optional" definition="file:/D:/REPOSITORIOS%20BEBT/PROYECTO%20CORE/Gestión/Brayan/GMF/Documentacion/WSDL_ESB/ReturnBalanceSettleAccGMF.wsdl" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><con:settings/><con:definitionCache type="TEXT" rootPart="file:/D:/REPOSITORIOS%20BEBT/PROYECTO%20CORE/Gestión/Brayan/GMF/Documentacion/WSDL_ESB/ReturnBalanceSettleAccGMF.wsdl"><con:part><con:url>file:/D:/REPOSITORIOS%20BEBT/PROYECTO%20CORE/Gestión/Brayan/GMF/Documentacion/WSDL_ESB/ReturnBalanceSettleAccGMF.wsdl</con:url><con:content><![CDATA[<wsdl:definitions name="ReturnBalanceSettleAccGMF" targetNamespace="urn://grupoaval.com/accounts/v1/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <wsdl:types>
    <xsd:schema>
      <xsd:import namespace="urn://grupoaval.com/accounts/v1/"/>
    </xsd:schema>
    <xsd:schema attributeFormDefault="unqualified" elementFormDefault="unqualified" targetNamespace="urn://grupoaval.com/xsd/ifx/" xmlns="http://www.w3.org/2001/XMLSchema" xmlns:aval="urn://grupoaval.com/xsd/ifx/" xmlns:avalv2="urn://grupoaval.com/xsd/ifx/v2/">
      ...
      <xsd:element name="IssDt" type="xsd:string"/>
...
</wsdl:definitions>]]></con:content><con:type>http://schemas.xmlsoap.org/wsdl/</con:type></con:part></con:definitionCache><con:endpoints><con:endpoint>https://10.200.157.5:9023/accounts/SSL/ReturnBalanceSettleAccGMF</con:endpoint></con:endpoints><con:operation id="edec6a5f-f9e6-4d07-85c4-30a053c751d5" isOneWay="false" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF" name="AddReturnBalanceSettleAccGMF" bindingOperationName="AddReturnBalanceSettleAccGMF" type="Request-Response" inputName="" receivesAttachments="false" sendsAttachments="false" anonymous="optional"><con:settings/><con:call id="70523d5e-af1f-4cd2-aadf-29f3d6acb2cb" name="Exitoso SE"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:encoding>UTF-8</con:encoding><con:endpoint>https://10.200.157.5:9023/accounts/SSL/ReturnBalanceSettleAccGMF</con:endpoint><con:request><![CDATA[<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:ifx="urn://grupoaval.com/xsd/ifx/" xmlns:v2="urn://grupoaval.com/xsd/ifx/v2/">\r
   <soapenv:Header/>\r
   <soapenv:Body>\r
      <v1:addRtnBcSettleAccGMFRequest>\r
         <v1:RtnBcSettleAccGMFRq>\r
           <ifx:RqUID xmlns:ifx="urn://grupoaval.com/xsd/ifx/">202504021589637</ifx:RqUID>
            ...
            <ifx:ProductId>\r
               <ifx:Concept>SE</ifx:Concept>\r
               <ifx:AccountNumber>500800124811</ifx:AccountNumber>\r               
               <ifx:Amt>1000</ifx:Amt>\r
            </ifx:ProductId>\r
         </v1:RtnBcSettleAccGMFRq>\r
      </v1:addRtnBcSettleAccGMFRequest>\r
   </soapenv:Body>\r
</soapenv:Envelope>]]></con:request><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:wsaConfig mustUnderstand="NONE" version="200508" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF"/><con:wsrmConfig version="1.2"/></con:call><con:call id="3e58ffb8-8ca2-469c-bcf2-f6c01184f598" name="Error de Negocio"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:encoding>UTF-8</con:encoding><con:endpoint>https://10.200.157.5:9023/accounts/SSL/ReturnBalanceSettleAccGMF</con:endpoint><con:request><![CDATA[<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:ifx="urn://grupoaval.com/xsd/ifx/" xmlns:v2="urn://grupoaval.com/xsd/ifx/v2/">\r
   <soapenv:Header/>\r
   <soapenv:Body>\r
      <v1:addRtnBcSettleAccGMFRequest>\r
         <v1:RtnBcSettleAccGMFRq>\r
            <ifx:RqUID>${=java.lang.System.currentTimeMillis()}</ifx:RqUID>\r
            <ifx:MsgRqHdr>\r
               <ifx:ClientApp>\r
                  <ifx:Org>BPOP</ifx:Org>\r
                  <ifx:Name>CANALES</ifx:Name>\r
                  <ifx:Version>1</ifx:Version>\r
               </ifx:ClientApp>\r
               <v2:Channel>CANALES</v2:Channel>\r
               <ifx:BankInfo>\r
                  <ifx:BankId>0002</ifx:BankId>\r
                  <ifx:Name>BPOP</ifx:Name>\r
                  <ifx:BranchId>025</ifx:BranchId>\r
               </ifx:BankInfo>\r
               <v2:ClientDt>2024-03-08T10:00:00</v2:ClientDt>\r
               <v2:IPAddr>1</v2:IPAddr>\r
               <ifx:UserId>\r
                  <ifx:GovIssueIdent>\r
                     <ifx:GovIssueIdentType>CC</ifx:GovIssueIdentType>\r
                     <ifx:IdentSerialNum>79641609B</ifx:IdentSerialNum>\r
                  </ifx:GovIssueIdent>\r
               </ifx:UserId>\r
               <v2:Reverse>false</v2:Reverse>\r
               <v2:Language>ES</v2:Language>\r
               <v2:NextDay>2021-07-16T17:14:59.489-05:00</v2:NextDay>\r
            </ifx:MsgRqHdr>\r
            <ifx:CustId>\r
               <ifx:GovIssueIdent>\r
                  <ifx:GovIssueIdentType>1</ifx:GovIssueIdentType>\r
                  <ifx:IdentSerialNum>79641609</ifx:IdentSerialNum>\r
               </ifx:GovIssueIdent>\r
            </ifx:CustId>\r
            <ifx:ProductId>\r
               <ifx:Concept>SE</ifx:Concept>\r
               <ifx:AccountNumber>500a800124811</ifx:AccountNumber>\r
               <ifx:Amt>1000</ifx:Amt>\r
            </ifx:ProductId>\r
         </v1:RtnBcSettleAccGMFRq>\r
      </v1:addRtnBcSettleAccGMFRequest>\r
   </soapenv:Body>\r
</soapenv:Envelope>]]></con:request><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:wsaConfig mustUnderstand="NONE" version="200508" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF"/><con:wsrmConfig version="1.2"/></con:call><con:call id="15da9b9a-929b-4db7-845c-232eccfe6e9c" name="Exitoso DD"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:encoding>UTF-8</con:encoding><con:endpoint>https://10.200.157.5:9023/accounts/SSL/ReturnBalanceSettleAccGMF</con:endpoint><con:request><![CDATA[<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:ifx="urn://grupoaval.com/xsd/ifx/" xmlns:v2="urn://grupoaval.com/xsd/ifx/v2/">\r
   <soapenv:Header/>\r
   <soapenv:Body>\r
      <v1:addRtnBcSettleAccGMFRequest>\r
         <v1:RtnBcSettleAccGMFRq>\r
...
</soapenv:Envelope>]]></con:request><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:wsaConfig mustUnderstand="NONE" version="200508" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF"/><con:wsrmConfig version="1.2"/></con:call><con:call id="6803e1aa-d751-42a3-b5de-0ae50307a885" name="Error de Timeout"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.WsdlRequest@request-headers">&lt;xml-fragment/></con:setting></con:settings><con:encoding>UTF-8</con:encoding><con:endpoint>https://10.200.157.5:9023/accounts/SSL/ReturnBalanceSettleAccGMF</con:endpoint><con:request><![CDATA[<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:ifx="urn://grupoaval.com/xsd/ifx/" xmlns:v2="urn://grupoaval.com/xsd/ifx/v2/">\r
   <soapenv:Header/>\r
   <soapenv:Body>\r
      <v1:addRtnBcSettleAccGMFRequest>\r
         <v1:RtnBcSettleAccGMFRq>\r
...
</soapenv:Envelope>]]></con:request><con:credentials><con:authType>No Authorization</con:authType></con:credentials><con:jmsConfig JMSDeliveryMode="PERSISTENT"/><con:jmsPropertyConfig/><con:wsaConfig mustUnderstand="NONE" version="200508" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF"/><con:wsrmConfig version="1.2"/></con:call></con:operation></con:interface><con:mockService id="be6ec964-9785-44c9-b382-28a2905aeb44" port="8080" path="/" host="W000441GIA18" name="MockService 1"><con:settings><con:setting id="com.eviware.soapui.impl.wsdl.mock.WsdlMockService@require-soap-action">false</con:setting></con:settings><con:properties/><con:mockOperation name="AddReturnBalanceSettleAccGMF" id="7933bd5d-bc6c-441d-8579-d25bbba56a5f" interface="ReturnBalanceSettleAccGMF" operation="AddReturnBalanceSettleAccGMF"><con:settings/><con:defaultResponse>Response 1</con:defaultResponse><con:dispatchStyle>SEQUENCE</con:dispatchStyle><con:response name="Response 1" id="4c7873a4-515c-468a-abe6-251c49f5ef16" httpResponseStatus="200" encoding="UTF-8"><con:settings/><con:responseContent><![CDATA[<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v1="urn://grupoaval.com/accounts/v1/" xmlns:ifx="urn://grupoaval.com/xsd/ifx/" xmlns:v2="urn://grupoaval.com/xsd/ifx/v2/">
   <soapenv:Header/>
   <soapenv:Body>
      <v1:addRtnBcSettleAccGMFResponse>
         <v1:RtnBcSettleAccGMFRs>
            <ifx:Status>
               <ifx:StatusCode>?</ifx:StatusCode>
               <!--Optional:-->
               <ifx:ServerStatusCode>?</ifx:ServerStatusCode>
               <!--Optional:-->
               <ifx:Severity>?</ifx:Severity>
               <!--Optional:-->
               <ifx:StatusDesc>?</ifx:StatusDesc>
               <!--Optional:-->
               <ifx:ServerStatusDesc>?</ifx:ServerStatusDesc>
            ...
            <ifx:MsgRqHdr>
               ...
               <ifx:BankInfo>
                  <!--Optional:-->
                  <ifx:BankIdType>?</ifx:BankIdType>
                  <ifx:BankId>?</ifx:BankId>
                  <!--Optional:-->
                  <ifx:RefInfo>
                     <ifx:RefType>?</ifx:RefType>
                     <ifx:RefId>?</ifx:RefId>
                  </ifx:RefInfo>
                  <!--Optional:-->
                  <ifx:Name>?</ifx:Name>
                  <!--Optional:-->
                  <ifx:BranchId>?</ifx:BranchId>
                  <!--Optional:-->
                  <ifx:BranchName>?</ifx:BranchName>
                  <!--Optional:-->
                  <ifx:City>?</ifx:City>
                  <!--Optional:-->
                  <ifx:StateProv>?</ifx:StateProv>
                  <!--Optional:-->
                  <ifx:PostalCode>?</ifx:PostalCode>
                  <!--Optional:-->
                  <ifx:Country>?</ifx:Country>
               </ifx:BankInfo>
               <!--Optional:-->
               <v2:ClientDt>?</v2:ClientDt>
               <!--Optional:-->
               <v2:IPAddr>?</v2:IPAddr>
               <!--Optional:-->
               <v2:SessKey>?</v2:SessKey>
               <!--Optional:-->
               <ifx:UserId>
                  <!--Optional:-->
                  <ifx:CustPermId>?</ifx:CustPermId>
                  <!--Optional:-->
                  <ifx:CustLoginId>?</ifx:CustLoginId>
                  <!--Optional:-->
                  <ifx:GovIssueIdent>
                     <ifx:GovIssueIdentType>?</ifx:GovIssueIdentType>
                     <ifx:IdentSerialNum>?</ifx:IdentSerialNum>
                     <!--Optional:-->
                     <ifx:GovOrg>?</ifx:GovOrg>
                     <!--Optional:-->
                     <ifx:GovOrgName>?</ifx:GovOrgName>
                     <!--Optional:-->
                     <ifx:GovRank>?</ifx:GovRank>
                     <!--Optional:-->
                     <ifx:StateProv>?</ifx:StateProv>
                     <!--Optional:-->
                     <ifx:Country>?</ifx:Country>
                  ...
                  <ifx:CustName>
                     <!--Optional:-->
                     <ifx:LastName>?</ifx:LastName>
                     <!--Optional:-->
                     <ifx:FirstName>?</ifx:FirstName>
                     <!--Optional:-->
                     <ifx:Nickname>?</ifx:Nickname>
                     <!--Optional:-->
                     <ifx:LegalName>?</ifx:LegalName>
                  </ifx:CustName>
               </ifx:UserId>
               <!--Optional:-->
               <v2:KeyAcctId>?</v2:KeyAcctId>
               <v2:Reverse>?</v2:Reverse>
               <v2:Language>?</v2:Language>
               <!--Optional:-->
               <v2:NextDay>?</v2:NextDay>
            </ifx:MsgRqHdr>
            <!--Optional:-->
            <ifx:MsgRsHdr>
               <!--Optional:-->
               <ifx:TxCostAmt>
                  <ifx:CurAmt>
                     <ifx:Amt>?</ifx:Amt>
                     <!--Optional:-->
                     <ifx:CurCode>?</ifx:CurCode>
                     <!--Optional:-->
                     <ifx:CurRate>?</ifx:CurRate>
                     <!--Optional:-->
                     <ifx:CurConvertRule>?</ifx:CurConvertRule>
                  </ifx:CurAmt>
               </ifx:TxCostAmt>
               <!--Optional:-->
               <ifx:EffDt>?</ifx:EffDt>
               <!--Optional:-->
               <ifx:RemainRec>?</ifx:RemainRec>
            </ifx:MsgRsHdr>
            <!--Optional:-->
            <ifx:CustId>
               <!--Optional:-->
...
</soapenv:Envelope>]]></con:responseContent><con:wsaConfig mustUnderstand="NONE" version="200508" action="urn://grupoaval.com/accounts/v1/AddReturnBalanceSettleAccGMF"/></con:response><con:dispatchConfig/></con:mockOperation></con:mockService><con:properties/><con:wssContainer/><con:oAuth2ProfileContainer/><con:oAuth1ProfileContainer/><con:sensitiveInformation/></con:soapui-project>
